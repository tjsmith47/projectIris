...
import atexit, os, sys, threading, collections
...
# Exception set if an internal assertion fails.
_global_failed_assertion = None
...
def _wrap_sdk_function(dll, name, argtypes, restype):
  try:
    ...
    def wrapper(*args, **kwargs):
      global _global_failed_assertion
      rv = func(*args, **kwargs)
      failed_assertion = _global_failed_assertion
      if failed_assertion:
        _global_failed_assertion = None
...
def init(eventLoopType = None):
  ...
  if   get_major_version() != 1\
    or get_minor_version() != 9\
    or get_patch_version() != 0\
    or get_build_number () != 44955:
...
def keysym_to_unicode(keysym):
  ...
  rv = __nativeKeysymToUnicode(keysym)
  return rv

def set_assertion_handler_internal(handler):
  '''@internal
  This should not be called directly.
  '''
  rv = __nativeSetAssertionHandlerInternal(handler)
  return rv

__AssertionHandler = _CT.CFUNCTYPE(None, _CT.c_char_p)
...
__nativeKeysymToUnicode = SdkDll.register_floating_function('vnc_keysymToUnicode', [_CT.c_uint], _CT.c_uint)
__nativeSetAssertionHandlerInternal = SdkDll.register_floating_function('vnc_setAssertionHandlerInternal', [__AssertionHandler], __AssertionHandler)
...
class AnnotationManager(object):
  ...
  class Callback(object):
    ...
    def __init__(self, availability_changed=None):
      ...
      self._annotationmanager_callback = AnnotationManager.Callback.CallbackImpl(
        _CT.CFUNCTYPE(None, _CT.c_void_p, _CT.c_void_p, _CT.c_int)(_availability_changed if self.availability_changed else 0),
      )
      _global_native_pointer_lookup[_CT.addressof(self._annotationmanager_callback)] = self
  ...
  def set_callback(self, callback):
    ...
    '''
    if not self._getNativePtr(): raise DestroyedObjectException()
    callback_ = _CT.pointer(callback._annotationmanager_callback) if callback is not None else None
...
class CloudAddressMonitor(object):
  ...
  class Callback(object):
    ...
    def __init__(self, availability_changed=None, monitor_paused=None):
      ...
      self._cloudaddressmonitor_callback = CloudAddressMonitor.Callback.CallbackImpl(
      ...
      _global_native_pointer_lookup[_CT.addressof(self._cloudaddressmonitor_callback)] = self
  ...
  def __init__(self, connector, cloud_addresses, callback):
    ...
    callback_ = _CT.pointer(callback._cloudaddressmonitor_callback) if callback is not None else None
  ...
  def destroy(self):
    ...
    assert rv is None
    if _global_native_pointer_lookup:
...
class CloudListener(object):
  ...
  class Callback(object):
    ...
    def __init__(self, listening_failed=None, filter_connection=None, listening_status_changed=None):
      ...
      self._cloudlistener_callback = CloudListener.Callback.CallbackImpl(
      ...
      _global_native_pointer_lookup[_CT.addressof(self._cloudlistener_callback)] = self
  ...
  def __init__(self, local_cloud_address, local_cloud_password, connection_handler, callback):
    ...
    if callback is None:
        raise ValueError('callback is a mandatory argument')
    callback_ = _CT.pointer(callback._cloudlistener_callback) if callback is not None else None
...
class DataStore(object):
  class Callback(object):
    ...
    def __init__(self, put=None, get=None):
      ...
      self._datastore_callback = DataStore.Callback.CallbackImpl(
      ...
      _global_native_pointer_lookup[_CT.addressof(self._datastore_callback)] = self
  ...
  def create_custom_store(callback):
    ...
    if callback is None:
        raise ValueError('callback is a mandatory argument')
    callback_ = _CT.pointer(callback._datastore_callback) if callback is not None else None
...
class DirectTcpListener(object):
  ...
  class Callback(object):
    ...
    def __init__(self, filter_connection=None):
      ...
      self._directtcplistener_callback = DirectTcpListener.Callback.CallbackImpl(
      ...
      _global_native_pointer_lookup[_CT.addressof(self._directtcplistener_callback)] = self
  ...
  def __init__(self, port, address_list, connection_handler, callback):
    ...
    if connection_handler is None:
      ...
      connection_handler_ = connection_handler._getNativePtr()
      if not connection_handler_: raise DestroyedObjectException()
    callback_ = _CT.pointer(callback._directtcplistener_callback) if callback is not None else None
...
class DirectUdpConnector(object):
  ...
  def connect(self, host_or_ip_address, port, connection_handler):
    ...
    if connection_handler is None:
      ...
      if not connection_handler_: raise DestroyedObjectException()
    rv = self.__nativeConnect(self._getNativePtr(), host_or_ip_address, port, connection_handler_)
    if rv == 0: _throwVncException("DirectUdpConnector.connect()")

  def __init__(self):
    '''Creates a new UDP Connector which is used to make outgoing connections
    to UDP listeners.
    '''
    rv = self._nativePtr = DirectUdpConnector.__nativeCreate()
    if not self._getNativePtr(): _throwVncException("DirectUdpConnector.__init__()")
    _global_native_pointer_lookup[self._getNativePtr()] = self
  ...
  __nativeConnect = SdkDll.register_class_function('vnc_DirectUdpConnector_connect', [_CT.c_void_p, _CT.c_char_p, _CT.c_int, _CT.c_void_p], _CT.c_int)
  __nativeCreate = SdkDll.register_class_function('vnc_DirectUdpConnector_create', [], _CT.c_void_p)
  __nativeDestroy = SdkDll.register_class_function('vnc_DirectUdpConnector_destroy', [_CT.c_void_p], None)
  def __del__(self):
    if hasattr(self, "_nativePtr") and self._nativePtr is not None:
      self.destroy()
  def __enter__(self):
...
class DirectUdpListener(object):
  ...
  class Callback(object):
    ...
    def __init__(self, filter_connection=None):
      ...
      self._directudplistener_callback = DirectUdpListener.Callback.CallbackImpl(
        _CT.CFUNCTYPE(_CT.c_int, _CT.c_void_p, _CT.c_void_p, _CT.c_char_p, _CT.c_int)(_filter_connection if self.filter_connection else 0),
      )
      _global_native_pointer_lookup[_CT.addressof(self._directudplistener_callback)] = self
  ...
  def __init__(self, port, address_list, connection_handler, callback):
    ...
    if connection_handler is None:
      ...
      connection_handler_ = connection_handler._getNativePtr()
      if not connection_handler_: raise DestroyedObjectException()
    callback_ = _CT.pointer(callback._directudplistener_callback) if callback is not None else None
    rv = self._nativePtr = DirectUdpListener.__nativeCreate(port, address_list, connection_handler_, callback_, callback_)
    if not self._getNativePtr(): _throwVncException("DirectUdpListener.__init__()")
    _global_native_pointer_lookup[self._getNativePtr()] = self
  ...
  __nativeCreate = SdkDll.register_class_function('vnc_DirectUdpListener_create', [_CT.c_int, _CT.c_char_p, _CT.c_void_p, _CT.POINTER(Callback.CallbackImpl), _CT.c_void_p], _CT.c_void_p)
  __nativeDestroy = SdkDll.register_class_function('vnc_DirectUdpListener_destroy', [_CT.c_void_p], None)
  def __del__(self):
    if hasattr(self, "_nativePtr") and self._nativePtr is not None:
      self.destroy()
  def __enter__(self):
...
class DisplayManager(object):
  ...
  class Callback(object):
    ...
    def __init__(self, displays_changed=None):
      ...
      self._displaymanager_callback = DisplayManager.Callback.CallbackImpl(
        _CT.CFUNCTYPE(None, _CT.c_void_p, _CT.c_void_p)(_displays_changed if self.displays_changed else 0),
      )
      _global_native_pointer_lookup[_CT.addressof(self._displaymanager_callback)] = self
  ...
  def enable(self, enable):
    ...
    '''
    if not self._getNativePtr(): raise DestroyedObjectException()
    rv = self.__nativeEnable(self._getNativePtr(), bool(enable))
    if rv == 0: _throwVncException("DisplayManager.enable()")
  ...
  def get_display_index(self):
    ...
    '''
    if not self._getNativePtr(): raise DestroyedObjectException()
    rv = self.__nativeGetDisplayIndex(self._getNativePtr())
    return rv
  ...
  def is_enabled(self):
    ...
    '''
    if not self._getNativePtr(): raise DestroyedObjectException()
    rv = self.__nativeIsEnabled(self._getNativePtr())
    return bool(rv)
  ...
  def is_select_display_allowed(self):
    '''Returns whether the selectDisplay() call is permitted.
    '''
    if not self._getNativePtr(): raise DestroyedObjectException()
    rv = self.__nativeIsSelectDisplayAllowed(self._getNativePtr())
    return bool(rv)
  ...
  def set_callback(self, callback):
    ...
    '''
    if not self._getNativePtr(): raise DestroyedObjectException()
    callback_ = _CT.pointer(callback._displaymanager_callback) if callback is not None else None
    rv = self.__nativeSetCallback(self._getNativePtr(), callback_, callback_)
    if rv == 0: _throwVncException("DisplayManager.set_callback()")

  __nativeEnable = SdkDll.register_class_function('vnc_DisplayManager_enable', [_CT.c_void_p, _CT.c_int], _CT.c_int)
  __nativeGetDisplayCount = SdkDll.register_class_function('vnc_DisplayManager_getDisplayCount', [_CT.c_void_p], _CT.c_int)
  __nativeGetDisplayIndex = SdkDll.register_class_function('vnc_DisplayManager_getDisplayIndex', [_CT.c_void_p], _CT.c_int)
  ...
  __nativeIsEnabled = SdkDll.register_class_function('vnc_DisplayManager_isEnabled', [_CT.c_void_p], _CT.c_int)
  __nativeIsPrimary = SdkDll.register_class_function('vnc_DisplayManager_isPrimary', [_CT.c_void_p, _CT.c_int], _CT.c_int)
  __nativeIsSelectDisplayAllowed = SdkDll.register_class_function('vnc_DisplayManager_isSelectDisplayAllowed', [_CT.c_void_p], _CT.c_int)
...
class EventLoopFd(object):
  ...
  class Callback(object):
    ...
    def __init__(self, event_updated=None, timer_updated=None):
      ...
      self._eventloopfd_callback = EventLoopFd.Callback.CallbackImpl(
      ...
      _global_native_pointer_lookup[_CT.addressof(self._eventloopfd_callback)] = self
  ...
  def set_callback(callback):
    ...
    '''
    callback_ = _CT.pointer(callback._eventloopfd_callback) if callback is not None else None
...
class EventLoopWin(object):
  class Callback(object):
    ...
    def __init__(self, event_updated=None, timer_updated=None):
      ...
      self._eventloopwin_callback = EventLoopWin.Callback.CallbackImpl(
        _CT.CFUNCTYPE(None, _CT.c_void_p, _CT.c_void_p, _CT.c_int)(_event_updated if self.event_updated else 0),
        _CT.CFUNCTYPE(None, _CT.c_void_p, _CT.c_int)(_timer_updated if self.timer_updated else 0),
      )
      _global_native_pointer_lookup[_CT.addressof(self._eventloopwin_callback)] = self
  ...
  def set_callback(callback):
    '''Sets the event loop callback.
    '''
    callback_ = _CT.pointer(callback._eventloopwin_callback) if callback is not None else None
...
class Logger(object):
  ...
  class Callback(object):
    ...
    def __init__(self, log_message=None):
      ...
      self._logger_callback = Logger.Callback.CallbackImpl(
        _CT.CFUNCTYPE(None, _CT.c_void_p, _CT.c_int, _CT.c_char_p)(_log_message if self.log_message else 0),
      )
      _global_native_pointer_lookup[_CT.addressof(self._logger_callback)] = self
  ...
  def create_custom_logger(callback):
    ...
    if callback is None:
        raise ValueError('callback is a mandatory argument')
    callback_ = _CT.pointer(callback._logger_callback) if callback is not None else None
...
class MessagingManager(object):
  ...
  class Callback(object):
    ...
    def __init__(self, message_received=None):
      ...
      self._messagingmanager_callback = MessagingManager.Callback.CallbackImpl(
        _CT.CFUNCTYPE(None, _CT.c_void_p, _CT.c_void_p, _CT.c_void_p, _CT.c_void_p)(_message_received if self.message_received else 0),
      )
      _global_native_pointer_lookup[_CT.addressof(self._messagingmanager_callback)] = self
  ...
  def set_callback(self, callback):
    ...
    '''
    if not self._getNativePtr(): raise DestroyedObjectException()
    callback_ = _CT.pointer(callback._messagingmanager_callback) if callback is not None else None
    rv = self.__nativeSetCallback(self._getNativePtr(), callback_, callback_)
...
class ImmutablePixelFormat(object):
  ...
  def bgr888():
    ...
    '''
    rv = ImmutablePixelFormat.__nativeBgr888()
  ...
  def rgb555():
    ...
    '''
    rv = ImmutablePixelFormat.__nativeRgb555()
    return _global_native_pointer_lookup[rv] if rv in _global_native_pointer_lookup else ImmutablePixelFormat(rv)
  ...
  def rgb565():
    ...
    significant bit order
    '''
    rv = ImmutablePixelFormat.__nativeRgb565()
    return _global_native_pointer_lookup[rv] if rv in _global_native_pointer_lookup else ImmutablePixelFormat(rv)
  ...
  def rgb888():
    ...
    significant to least significant bit order
    '''
    rv = ImmutablePixelFormat.__nativeRgb888()
    return _global_native_pointer_lookup[rv] if rv in _global_native_pointer_lookup else ImmutablePixelFormat(rv)
...
class _Private(object):
  ...
  def get_parameter(parameter):
    ...
    '''
    parameter = _encode_unicode(parameter, False)
    rv = _Private.__nativeGetParameter(parameter)
    if not rv: _throwVncException("_Private.get_parameter()")
    return _decode_unicode(rv)
  ...
  def set_parameter(parameter, value):
    ...
    '''
    parameter = _encode_unicode(parameter, False)
    value = _encode_unicode(value, False)
    rv = _Private.__nativeSetParameter(parameter, value)
    if rv == 0: _throwVncException("_Private.set_parameter()")
  ...
  __nativeGetParameter = SdkDll.register_class_function('vnc_Private_getParameter', [_CT.c_char_p], _CT.c_char_p)
  ...
  __nativeSetParameter = SdkDll.register_class_function('vnc_Private_setParameter', [_CT.c_char_p, _CT.c_char_p], _CT.c_int)
  def __init__(self):
    raise UserWarning("constructing static/abstract class")
...
class RsaKey(object):
  class Callback(object):
    ...
    def __init__(self, details_ready=None):
      ...
      self._rsakey_callback = RsaKey.Callback.CallbackImpl(
        _CT.CFUNCTYPE(None, _CT.c_void_p, _CT.c_void_p, _CT.c_char_p, _CT.c_char_p)(_details_ready if self.details_ready else 0),
      )
      _global_native_pointer_lookup[_CT.addressof(self._rsakey_callback)] = self
  ...
  def cancel_details(_callback):
    ...
    '''
    rv = RsaKey.__nativeCancelDetails(_CT.pointer(_callback._rsakey_callback))
    assert rv is None
  ...
  def get_details(callback, generate_if_missing):
    ...
    '''
    callback_ = _CT.pointer(callback._rsakey_callback) if callback is not None else None
...
class Server(object):
  ...
  class AgentCallback(object):
    ...
    def __init__(self, agent_started=None, agent_stopped=None):
      ...
      self._server_agentcallback = Server.AgentCallback.AgentCallbackImpl(
      ...
      _global_native_pointer_lookup[_CT.addressof(self._server_agentcallback)] = self
  ...
  class ConnectionCallback(object):
    ...
    def __init__(self, connection_started=None, connection_ended=None):
      ...
      self._server_connectioncallback = Server.ConnectionCallback.ConnectionCallbackImpl(
      ...
      _global_native_pointer_lookup[_CT.addressof(self._server_connectioncallback)] = self

    connection_started = None
    connection_ended = None

  class InputEventsCallback(object):
    class InputEventsCallbackImpl(_CT.Structure):
      _fields_ = [
        ("pointerEventCallback", _CT.CFUNCTYPE(_CT.c_int, _CT.c_void_p, _CT.c_void_p, _CT.c_int, _CT.c_int, _CT.c_int, _CT.c_int)),
        ("keyEventCallback", _CT.CFUNCTYPE(_CT.c_int, _CT.c_void_p, _CT.c_void_p, _CT.c_int, _CT.c_int)),
      ]

    def __init__(self, pointer_event_callback=None, key_event_callback=None):
      if pointer_event_callback is not None:
        self.pointer_event_callback = pointer_event_callback

      if self.pointer_event_callback is not None and not callable(self.pointer_event_callback):
        raise TypeError('pointer_event_callback: callbacks must be callable')

      def _pointer_event_callback(_, server, x, y, button_mask, is_relative):
        is_relative = bool(is_relative)
        try:
          rv = self.pointer_event_callback(_global_native_pointer_lookup[server], x, y, button_mask, is_relative)
          rv = bool(rv)
          return rv
        except BaseException as e:
          _Private.logger_write(Logger.Level.ERROR, 'PythonSDK', 'callback pointerEventCallback generated an uncaught exception: \'%s\'' % e)
          return False

      if key_event_callback is not None:
        self.key_event_callback = key_event_callback

      if self.key_event_callback is not None and not callable(self.key_event_callback):
        raise TypeError('key_event_callback: callbacks must be callable')

      def _key_event_callback(_, server, key, down):
        down = bool(down)
        try:
          rv = self.key_event_callback(_global_native_pointer_lookup[server], key, down)
          rv = bool(rv)
          return rv
        except BaseException as e:
          _Private.logger_write(Logger.Level.ERROR, 'PythonSDK', 'callback keyEventCallback generated an uncaught exception: \'%s\'' % e)
          return False

      self._server_inputeventscallback = Server.InputEventsCallback.InputEventsCallbackImpl(
        _CT.CFUNCTYPE(_CT.c_int, _CT.c_void_p, _CT.c_void_p, _CT.c_int, _CT.c_int, _CT.c_int, _CT.c_int)(_pointer_event_callback if self.pointer_event_callback else 0),
        _CT.CFUNCTYPE(_CT.c_int, _CT.c_void_p, _CT.c_void_p, _CT.c_int, _CT.c_int)(_key_event_callback if self.key_event_callback else 0),
      )
      _global_native_pointer_lookup[_CT.addressof(self._server_inputeventscallback)] = self

    pointer_event_callback = None
  ...
  class SecurityCallback(object):
    ...
    def __init__(self, verify_peer=None, is_user_name_required=None, is_password_required=None, authenticate_user=None):
      ...
      self._server_securitycallback = Server.SecurityCallback.SecurityCallbackImpl(
      ...
      _global_native_pointer_lookup[_CT.addressof(self._server_securitycallback)] = self
  ...
  def enable_audio(self, enable):
    ...
    '''
    if not self._getNativePtr(): raise DestroyedObjectException()
    rv = self.__nativeEnableAudio(self._getNativePtr(), bool(enable))
    if rv == 0: _throwVncException("Server.enable_audio()")
  ...
  def set_agent_callback(self, callback):
    ...
    '''
    if not self._getNativePtr(): raise DestroyedObjectException()
    callback_ = _CT.pointer(callback._server_agentcallback) if callback is not None else None
  ...
  def set_connection_callback(self, callback):
    ...
    '''
    if not self._getNativePtr(): raise DestroyedObjectException()
    callback_ = _CT.pointer(callback._server_connectioncallback) if callback is not None else None
  ...
  def set_input_events_callback(self, callback):
    '''Sets input control related callbacks for the Server.
    '''
    if not self._getNativePtr(): raise DestroyedObjectException()
    callback_ = _CT.pointer(callback._server_inputeventscallback) if callback is not None else None
    rv = self.__nativeSetInputEventsCallback(self._getNativePtr(), callback_, callback_)
    if rv == 0: _throwVncException("Server.set_input_events_callback()")
  ...
  def set_security_callback(self, callback):
    ...
    '''
    if not self._getNativePtr(): raise DestroyedObjectException()
    callback_ = _CT.pointer(callback._server_securitycallback) if callback is not None else None
  ...
  __nativeEnableAudio = SdkDll.register_class_function('vnc_Server_enableAudio', [_CT.c_void_p, _CT.c_int], _CT.c_int)
  ...
  __nativeSetInputEventsCallback = SdkDll.register_class_function('vnc_Server_setInputEventsCallback', [_CT.c_void_p, _CT.POINTER(InputEventsCallback.InputEventsCallbackImpl), _CT.c_void_p], _CT.c_int)
...
class Viewer(object):
  ...
  class AuthenticationCallback(object):
    ...
    def __init__(self, request_user_credentials=None, cancel_user_credentials_request=None):
      ...
      self._viewer_authenticationcallback = Viewer.AuthenticationCallback.AuthenticationCallbackImpl(
      ...
      _global_native_pointer_lookup[_CT.addressof(self._viewer_authenticationcallback)] = self
  ...
  class ConnectionCallback(object):
    ...
    def __init__(self, connecting=None, connected=None, disconnected=None):
      ...
      self._viewer_connectioncallback = Viewer.ConnectionCallback.ConnectionCallbackImpl(
      ...
      _global_native_pointer_lookup[_CT.addressof(self._viewer_connectioncallback)] = self
  ...
  class FramebufferCallback(object):
    ...
    def __init__(self, server_fb_size_changed=None, viewer_fb_updated=None):
      ...
      self._viewer_framebuffercallback = Viewer.FramebufferCallback.FramebufferCallbackImpl(
      ...
      _global_native_pointer_lookup[_CT.addressof(self._viewer_framebuffercallback)] = self
  ...
  class PeerVerificationCallback(object):
    ...
    def __init__(self, verify_peer=None, cancel_peer_verification=None):
      ...
      self._viewer_peerverificationcallback = Viewer.PeerVerificationCallback.PeerVerificationCallbackImpl(
      ...
      _global_native_pointer_lookup[_CT.addressof(self._viewer_peerverificationcallback)] = self
  ...
  class ServerEventCallback(object):
    ...
    def __init__(self, server_clipboard_text_changed=None, server_friendly_name_changed=None):
      ...
      self._viewer_servereventcallback = Viewer.ServerEventCallback.ServerEventCallbackImpl(
      ...
      _global_native_pointer_lookup[_CT.addressof(self._viewer_servereventcallback)] = self
  ...
  def enable_audio(self, enable):
    ...
    if not self._getNativePtr(): raise DestroyedObjectException()
    rv = self.__nativeEnableAudio(self._getNativePtr(), bool(enable))
    if rv == 0: _throwVncException("Viewer.enable_audio()")
  ...
  def get_display_manager(self):
    return Viewer.__DisplayManagerImpl(self, Viewer.__nativeGetDisplayManager)
  ...
  def set_authentication_callback(self, callback):
    ...
    '''
    if not self._getNativePtr(): raise DestroyedObjectException()
    callback_ = _CT.pointer(callback._viewer_authenticationcallback) if callback is not None else None
  ...
  def set_connection_callback(self, callback):
    ...
    '''
    if not self._getNativePtr(): raise DestroyedObjectException()
    callback_ = _CT.pointer(callback._viewer_connectioncallback) if callback is not None else None
    rv = self.__nativeSetConnectionCallback(self._getNativePtr(), callback_, callback_)
  ...
  def set_framebuffer_callback(self, callback):
    ...
    '''
    if not self._getNativePtr(): raise DestroyedObjectException()
    callback_ = _CT.pointer(callback._viewer_framebuffercallback) if callback is not None else None
  ...
  def set_peer_verification_callback(self, callback):
    ...
    '''
    if not self._getNativePtr(): raise DestroyedObjectException()
    callback_ = _CT.pointer(callback._viewer_peerverificationcallback) if callback is not None else None
  ...
  def set_server_event_callback(self, callback):
    ...
    '''
    if not self._getNativePtr(): raise DestroyedObjectException()
    callback_ = _CT.pointer(callback._viewer_servereventcallback) if callback is not None else None
  ...
  __nativeEnableAudio = SdkDll.register_class_function('vnc_Viewer_enableAudio', [_CT.c_void_p, _CT.c_int], _CT.c_int)
  ...
  __nativeGetDisplayManager = SdkDll.register_class_function('vnc_Viewer_getDisplayManager', [_CT.c_void_p], _CT.c_void_p)
...
class DirectUdp(object):
  DEFAULT_PORT = 5900
  def __init__(self): pass

def __assertion_handler(message):
    global _global_failed_assertion
    _global_failed_assertion = AssertionError(message)

__assertion_handler_fn = __AssertionHandler(__assertion_handler)
set_assertion_handler_internal(__assertion_handler_fn)
