...
namespace BasicViewerCSharpWpf
{
    ...
    class VncLibraryThread : IDisposable
    {
        ...
        // To enable direct connectivity you need to copy the content of your add-on code here
        private const string DirectConnectivityAddOnCode = @"";
        ...
        /// </summary>
        /// <returns><see langword="true"/> on success or <see langword="false"/> if an
        ...
        private static void LibraryInit()
        {
            ...
            // Create a logger that writes to the standard error output stream.
            ...
            if (!string.IsNullOrEmpty(DirectConnectivityAddOnCode))
