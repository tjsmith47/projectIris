...
namespace BasicViewerCSharpWpf
{
    ...
    {
        // (DirectConnectivityAddOnCode is found in the VncLibraryThread.cs)
        ...
        private ConnectSettings ConnectSettings = new ConnectSettings
        {
            ...
            DirectConnectivityAddress = "",
            DirectConnectivityIpPort = 0,
        ...
        private async Task DisconnectSession(VncViewerSession viewerSession, int timeoutMs = 5000)
        {
            ...
            AudioIcon.Source = new BitmapImage(new Uri("Pictures/AudioMute.png", UriKind.Relative));
        ...
        private void StartConnection()
        {
            ...
            try
            {
                ...
                viewerSession = new VncViewerSession
                {
                    ...
                    DirectConnectivityAddress = ConnectSettings.DirectConnectivityAddress,
                    IpPort = ConnectSettings.DirectConnectivityIpPort,
        ...
        {
            ViewerSession?.LastDisplay();
        }
        private void Next_Click(object sender, RoutedEventArgs e)
        {
            ViewerSession?.NextDisplay();
        }

        private void Audio_Checked(object sender, RoutedEventArgs e)
        {
            ViewerSession?.EnableAudio(Audio.IsChecked == true);
            if (Audio.IsChecked == true)
                AudioIcon.Source = new BitmapImage(new Uri("Pictures/Audio.png", UriKind.Relative));
            else
                AudioIcon.Source = new BitmapImage(new Uri("Pictures/AudioMute.png", UriKind.Relative));
