...
listen for direct connections on a (known, static) IP address and 
...
3) If deploying to multiple devices, instruct device users to provide this 
   ...
   <configuration>\basicServer.exe <ip-port>
...
<configuration>\basicServer.exe <Cloud-addr> <Cloud-pwd> <ip-port>
