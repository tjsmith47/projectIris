...
establish direct connections (UDP or TCP) to computers listening on known IP addresses 
...
### Establishing UDP or TCP direct connectivity
...
3) If deploying to multiple devices, instruct device users to provide this 
   ...
   <configuration>\basicViewerWin.exe <Server-ip-address> <Server-ip-port>
