...
listen for direct connections (UDP or TCP) on a (known, static) IP address and 
...
service configuration file. The exception is the direct connectivity add-on code, 
